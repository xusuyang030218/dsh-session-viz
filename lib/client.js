...
`;
		...
		function HomeView({ closure, meta, turns, onJump, onOpenTree, onOpenSummary, onOpenMap }) {
			...
			}), "失败"))), (closure.rewindCount || 0) > 0 && react.default.createElement("div", { className: "dsvz-rewind-banner" }, react.default.createElement("span", { className: "ic" }, "↶"), react.default.createElement("span", { className: "tt" }, `会话发生过 ${closure.rewindCount} 次回退`), react.default.createElement("span", { className: "sub" }, `共撤回 ${closure.withdrawnCount ?? 0} 条事件；撤回内容已从闭环统计与时间线中剔除，详情见「摘要」与「事件树」。`)), react.default.createElement("div", { className: "dsvz-home-cards" }, cards.map((c) => react.default.createElement("div", {
				key: c.k,
		...
		function RewindBanner({ summary }) {
			...
			return react.default.createElement("div", { className: "dsvz-rewind-banner" }, react.default.createElement("span", { className: "ic" }, "↶"), react.default.createElement("span", { className: "tt" }, `会话发生过 ${summary.rewindCount ?? list.length} 次回退`), react.default.createElement("span", { className: "sub" }, `共撤回 ${summary.withdrawnCount ?? 0} 条事件${rolledFiles ? `、${rolledFiles} 个文件变更` : ""}；下方被划掉的事件即回退撤回的内容，不再计入本次会话的有效执行。`), list.map((r, i) => react.default.createElement("span", {
				key: i,
				className: "tgt",
				title: r.targetPreview ?? "（无文本）"
		...
		function SummaryView({ summary, onStory, onTree, onSelectFile, devMode, turns, onPos }) {
			...
			return react.default.createElement("div", {
				...
				onScroll
			}, react.default.createElement("div", { className: "dsvz-summary" }, react.default.createElement("div", { className: "dsvz-sum-hero" }, react.default.createElement("div", { className: "t" }, s.title ? `📋 ${s.title}` : "会话执行摘要"), s.userRequest && react.default.createElement("div", { className: "req" }, `「${esc(s.userRequest)}」`), react.default.createElement("div", { className: "stats" }, react.default.createElement("span", { className: "dsvz-stat" }, `🤖 ${s.turnCount} 轮对话`), react.default.createElement("span", { className: "dsvz-stat" }, `🪜 ${s.stepCount} 个步骤`), react.default.createElement("span", { className: "dsvz-stat" }, `⏱ 耗时 ${fmtDur(s.durationMs)}`), s.model && react.default.createElement("span", { className: "dsvz-stat" }, `🧠 ${esc(s.model)}`))), (s.rewinds || []).length > 0 && react.default.createElement(RewindBanner, { summary: s }), toolEntries.length > 0 && react.default.createElement("div", null, react.default.createElement("div", { className: "dsvz-sec" }, "工具使用"), react.default.createElement("div", { className: "dsvz-toolgrid" }, toolEntries.slice(0, 12).map(([name, v]) => react.default.createElement("div", {
				key: name,
			...
			}))), (s.rewoundFiles || []).length > 0 && react.default.createElement("div", null, react.default.createElement("div", { className: "dsvz-sec" }, `已回退的文件变更（${s.rewoundFiles.length}）`), react.default.createElement("div", { className: "dsvz-sum-rewound" }, react.default.createElement("div", { className: "dsvz-files" }, s.rewoundFiles.map((f, i) => react.default.createElement("div", {
				key: i,
				className: "dsvz-file wd"
			}, react.default.createElement("span", { className: "act m" }, "↶ 已回退"), react.default.createElement("span", {
				className: "pth",
				title: f.path
			}, devMode ? f.path : shortPath(f.path)), f.lines != null && react.default.createElement("span", { style: {
				fontSize: 10.5,
		...
		function StoryView({ story, baseTime, onOpenEvent, devMode, onPos }) {
			...
			return react.default.createElement("div", {
				...
				return react.default.createElement("div", {
					key,
					className: `dsvz-story-node ${n.kind}${open ? " open" : ""}${n.withdrawn ? " wd" : ""}`
				}, react.default.createElement("span", { className: "nt" }, relTime(n.time, baseTime)), react.default.createElement("span", { className: "nh" }, esc(n.human || "")), (n.kind === "reasoning" || n.kind === "user" || n.kind === "assistant" || n.kind === "rewind") && detail && react.default.createElement("span", {
					className: "arrow",
		...
		function TreeView({ turns, meta, typeCounts, groups, onSelectEvent, selectedLine, onPosChange, jumpSignal, onFocusStep, onClearEvent }) {
			...
			const turnEls = turns.map((tr) => {
				...
				const stepEls = tr.steps.map((st) => {
					...
					}, react.default.createElement("span", { className: "chev" }, "▶"), react.default.createElement("span", { className: "sb" }, `Step ${st.step}`), react.default.createElement("span", { className: "sm" }, `${fmtNum(st.eventCount)} 条 · ${fmtDur(dur(st))}${st.tools?.length ? " · " + [...new Set(st.tools)].slice(0, 3).join(", ") : ""}`), (st.withdrawnCount ?? 0) > 0 && react.default.createElement("span", {
						className: "dsvz-rewind-chip",
						title: "本步被回退撤回的事件"
					}, `已回退 ${st.withdrawnCount} 条`)), stepOpen && react.default.createElement("div", { className: "dsvz-groupwrap" }, groups.map((g, gi) => {
				...
				return react.default.createElement("div", {
					...
					onClick: () => toggleTurn(tr.turn)
				}, react.default.createElement("span", { className: "chev" }, "▶"), react.default.createElement("span", { className: "tb" }, `Turn ${tr.turn}`), react.default.createElement("span", { className: "tm" }, `${fmtNum(tr.eventCount)} 条 · ${fmtDur(dur(tr))}`), (tr.rewindCount ?? 0) > 0 && react.default.createElement("span", {
					className: "dsvz-rewind-chip",
					title: "本轮发生过就地回退"
				}, `↶ 回退 ${tr.rewindCount}`), (tr.withdrawnCount ?? 0) > 0 && react.default.createElement("span", {
					className: "dsvz-rewind-chip",
					title: "本轮被回退撤回的事件"
				}, `已回退 ${tr.withdrawnCount} 条`)), turnOpen && react.default.createElement("div", { className: "dsvz-stepwrap" }, stepEls, (tr.groups || []).filter(matchesType).filter(matchesSearch).map((g, gi) => {
		...
		function eventRow(ev, baseTime, selectedLine, onClick, g, ql) {
			...
			return react.default.createElement("div", {
				...
				title: ev.withdrawn ? "该事件已被回退撤回（不再生效）" : void 0
			...
			}, ev.type), inner, ev.withdrawn && react.default.createElement("span", { className: "wd-tag" }, "↶ 已回退"), react.default.createElement("span", { className: "ed" }, ev.time ? relTime(ev.time, baseTime) : ""));
		}
		...
		*/
		...
		function TurnCard({ ring, branches, total, selectedId, onSelect, onTip }) {
			const R = ring.radius;
			const mainCx = 150;
			...
			const svgWidth = branchCount > 0 ? 550 : 330;
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "seelogTurnIndex",
							children: ["#", String(ring.turn)]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						total > 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "seelogTurnOf",
							children: [
								"/ 共 ",
								String(total),
								" 轮"
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								String(ring.steps.length),
								" 步 · ",
								String(ring.nodes.length),
								" 事件"
							]
						}),
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
						...
						children: [
							...
							ring.steps.map((step, index) => {
								...
								const showStepLabel = step.step >= 0 && span > .2 && ring.steps.length <= 10;
								...
								}), showStepLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
				...
				children: [
					...
					snapshot !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: String(snapshot.sessions.reduce((total, session) => total + (session.rewindCount ?? 0), 0)) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "回退次数" })] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: String(snapshot.sessions.reduce((total, session) => total + (session.withdrawnEventCount ?? 0), 0)) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "撤回事件" })] }),
